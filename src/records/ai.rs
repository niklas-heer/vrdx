...
pub(super) fn guide() -> Value {
    json!({
        ...
        "interface": {
            ...
            "failure": {"schema_version": 1, "ok": false, "error": {"code": "stable_code", "message": "Human explanation"}},
            "exit_codes": {"0": "success", "1": "invalid collection or operational failure", "2": "usage", "3": "conflict", "4": "not found"},
        ...
        "commands": [
            ...
            {"name":"new","usage":"vrdx new TITLE [--tag TAG] [--date YYYY-MM-DD] [--status STATUS] [--body-file PATH] --json","writes":true,"purpose":"Create an independent record; default proposed; return generated ID and path"},
        ...
        "record_format": {
            ...
            "body_template": "## Decision\n\nState the choice and scope.\n\n## Context\n\nExplain constraints, evidence, and credible alternatives.\n\n## Consequences\n\nExplain benefits, costs, risks, trade-offs, and when to revisit.\n"
        },
        ...
        "writing_rules": ["One coherent consequential choice per record", "Use a specific action-oriented title and plain language", "Explain scope, evidence and constraints", "Name credible alternatives and actual trade-offs", "State uncertainties without inventing facts or consensus", "Preserve historical reasoning and stable IDs"],
        "workflow": ["Read guide", "Validate existing records", "Use context/search to find evidence", "Read full records with show; inspect chain and status", "Create a proposed decision using a prepared body file", "Only mark accepted when authorized by the user's decision or evidence", "Review suggestions before adding explicit relationships in Markdown", "Validate and review the diff"],

# Textual Library - Complete Reference Guide

A comprehensive consolidated reference document for the **Textual** Python library - a modern Python framework for building sophisticated terminal user interfaces (TUIs).
...
- **HOW TO**
  ...
  - [Design a Layout](#design-a-layout)
  - [Package a Textual app with Hatch](#package-a-textual-app-with-hatch)
  - [Render and compose](#render-and-compose)
  - [Style Inline Apps](#style-inline-apps)
  - [Save time with Textual containers](#save-time-with-textual-containers)
...
- **API**
  ...
  - [Style](#style)
  - [Suggester](#suggester)
  - [System Commands Source](#system-commands-source)
  - [Timer](#timer)
  - [Types](#types)
...
- **EVENTS**
  ...
  - [Blur](#blur)
  - [Click](#click)
  - [Descendant Blur](#descendant-blur)
  - [Descendant Focus](#descendant-focus)
  - [Enter](#enter)
  - [Focus](#focus)
  - [Hide](#hide)
  - [Key](#key)
  ...
  - [Mouse Scroll Left](#mouse-scroll-left)
  - [Mouse Scroll Right](#mouse-scroll-right)
...
- **STYLES**
  ...
  - [Border](#border)
  - [Border-subtitle-align](#border-subtitle-align)
  - [Border-subtitle-background](#border-subtitle-background)
  - [Border-subtitle-color](#border-subtitle-color)
  - [Border-subtitle-style](#border-subtitle-style)
  - [Border-title-align](#border-title-align)
  - [Border-title-background](#border-title-background)
  - [Border-title-color](#border-title-color)
  - [Border-title-style](#border-title-style)

...
- [x] Evaluate triggering with Cursor CLI (Grok 4.6) and Claude Code in disposable projects; Codex was not run (account usage limit until 2026-09-26). No tuning was needed.
